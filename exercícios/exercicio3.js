...
ddis.forEach((pais) => {
    if (ddi == pais.dial_code) {
        console.log("Esse DDI é do país com o seguinte nome: " + pais.name);
        achou = true;
    }
});

if (!achou) {
    console.log("Não encontramos nenhum pais com esse DDI informado!");
}
...
var salario = prompt("Insira o valor do seu salário: ");
var emprestimo = prompt("Insira o valor do empréstimo: ");
var num_prestacoes = prompt("Informe o número de prestações: ");

if (emprestimo / num_prestacoes > salario * 0.3) {
    console.log("Infelizmente não podemos conceder o empréstimo nessas condições");
} else {
    console.log("Você é apto a receber o empréstimo!");
}

// 5. Faça um programa que calcule e imprima o valor em reais de cada kw, o valor em reais a ser pago 
...
var salariomin = prompt("Insira o valor do salário mínimo R$: ");
var consumoKw = prompt("Insira o consumo em Kw do mês: ");

var valorKw = (salariomin * 1 / 7) / 100;

console.log("O valor de cada Kw é R$: " + valorKw);
console.log("O valor da conta de energia é R$: " + valorKw * consumoKw);
console.log("O novo valor a ser pago por essa residência com um desconto de 10% é R$: " + valorKw * consumoKw * 0.1);
...
var preco = prompt("Insira o preço do produto R$: ");
console.log("Escolha uma das opções de pagamento abaixo: ");
...
switch (escolha) {
    case '1':
        console.log("O valor a ser pago é R$: " + preco * 0.9);
        break;
    case '2':
